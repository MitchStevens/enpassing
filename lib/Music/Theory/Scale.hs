...
dorian     = aeolian & degree VI  %~ flat
phrygian   = aeolian & degree II  %~ flat
lydian     = ionian  & degree IV  %~ flat
mixolydian = ionian  & degree VII %~ flat
aeolian    = mode ["P1", "M2", "m3", "P4", "P5", "m6", "m7"]
locrian    = aeolian & degree II  %~ flat
                     & degree V   %~ flat
